...
import com.qinC.common.to.mq.StockDetailTo;
...
import com.qinC.mall.ware.feign.OrderFeignService;
import com.qinC.mall.ware.feign.ProductFeignService;
import com.qinC.mall.ware.service.WareOrderTaskDetailService;
import com.qinC.mall.ware.service.WareOrderTaskService;
import com.qinC.mall.ware.vo.OrderItemVo;
import com.qinC.mall.ware.vo.OrderVo;
...
import com.qinC.mall.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    @Autowired
    private WareOrderTaskService orderService;

    @Autowired
    private WareOrderTaskDetailService orderDetailService;
    ...
    public void addStock(Long skuId, Long wareId, Integer skuNum) {
        ...
        if (wareSkuEntities == null || wareSkuEntities.size() == 0) {
            ...
            //remote call
            try {
                SkuInfoTo skuInfoTo = productFeignService.skuName(skuId);
                if (skuInfoTo != null) {
